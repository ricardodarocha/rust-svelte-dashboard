<script>
  ...
  function fakeData(times, maxValue = 100, minValue = 50) {
		...
		const teste = {}
		const res = fetch("http://localhost:3001/metrica/alfa/30");
  ...
  function realData(times, key="ALFA") {
		let data
    fetch('localhost:3000/metrica/' + key + '/' + times)
...
<div class="wrapper">
	<div class="header">
		<h1>Monitor Postgres <mark>Quiu</mark></h1>
		<LinkedChart data={ fakeData(108) } width="540" height="5" hover={ false } />
	</div>

	<div class="block block--single">
		<p>Monitoramento de Banco de Dados em tempo real</p>

		<p><em>Time Pinguins</em></p>
		...
		<table class="preview-table">
			<tr>
				<th>Name</th>
				<th width="150"><LinkedLabel linked="table" empty="monitoramento" /></th>
				<th>Value</th>
			</tr>
        ...
        <tr>
          <td class="label">A thing using lines</td>
          <td>
            <LinkedChart data={ fakeData(30) } linked="link-9" type="line" />
            <LinkedChart data={ fakeData(30) } linked="link-9" type="line" />
            <LinkedChart data={ fakeData(30) } linked="link-9" type="line" />
            <LinkedChart data={ fakeData(30) } linked="link-9" type="line" lineColor="#4355db" fill="var(--text-color)" showValue="true" valuePosition="floating" />
          </td>
          <td></td>
        </tr>
	...
	<div class="block block--single">
		<p>
			Inicie o serviço coletor na base de dados do cliente. É necessário informar os parâmetros conforme a documentação   
		</p>

		<code class="well">
			quiu-monitor.exe -q -q -q 
		</code>

    <p> Em seguida inicie este serviço na porta 3000</p>
      <code class="well">
        &lt;LinkedChart &#123; data &#125; /&gt;
      </code>
      
      <p> O coletor pode ser testado com a seguinte sql</p>
	...
	<div class="block block--single">
		Fabricado por <a href="https://github.com/ricardodarocha">Ricardo da Rocha</a>
	</div>
</div>
